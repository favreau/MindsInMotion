  ...
  interact(others) {
    for (let other of others) {
      if (other !== this) {
        ...
        if (d < attractionDistance) {  // Attraction range
        ...
        if (d < influenceDistance) {  // Interaction range for color influence
          ...
          if (other.charge > 0) {
            ...
            this.color = lerpColor(this.color, other.color, influenceStrength * powerOfLove * 0.05);
            ...
            this.color = lerpColor(this.color, color(0, 0, 0), influenceStrength * 0.001);
